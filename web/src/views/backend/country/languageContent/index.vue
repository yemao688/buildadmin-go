<template>
    <div class="default-main ba-table-box">
        ...
        <TableHeader
            ...
            :quick-search-placeholder="t('Quick search placeholder', { fields: t('country.languageContent.quick Search Fields') })"
        ></TableHeader>
...
const baTable = new baTableClass(
    new baTableApi('/admin/country.LanguageContent/'),
    {
        ...
        column: [
            ...
            { label: t("country.languageContent.type"), prop: "type", align: "center", operator: "eq", sortable: false, replaceValue: { "0": t('country.languageContent.type 0'), "1": t('country.languageContent.type 1'), "2": t('country.languageContent.type 2')} },
