        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    ...
                    <FormItem :label="t('country.languageContent.type')" type="select" v-model="baTable.form.items!.type" prop="type" :data="{ content: { '0': t('country.languageContent.type 0'), '1': t('country.languageContent.type 1'), '2': t('country.languageContent.type 2') } }" :placeholder="t('Please select field', { field: t('country.languageContent.type') })" />
