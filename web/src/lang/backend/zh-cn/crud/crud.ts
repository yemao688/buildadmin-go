export default {
    ...
    // data scope (Phase 1C)
    'Data scope': '数据归属',
    'Data scope mode': '归属模式',
    'Data scope mode auto': '自动识别',
    'Data scope mode required': '指定归属字段',
    'Data scope mode none': '全局数据',
    'Data scope owner column': '归属字段',
    'Data scope assign on create': '新增时自动绑定当前管理员',
    'Data scope preview': '解析预览',
    'Data scope admin data': '检测到 admin_id，当前数据为管理员层级数据，新增记录时将自动绑定当前管理员。',
    'Data scope global data': '未检测到 admin_id，当前数据为全局数据。',
    'Data scope required preview': '归属字段：{field}，新增时{assign}。',
    'Data scope required no owner': '请从兼容字段中选择一个归属字段。',
    'Data scope assign yes': '自动绑定当前管理员',
    'Data scope assign no': '不自动绑定当前管理员',
    'Data scope none preview': '当前数据为全局数据，不启用管理员层级隔离。',
    'Data scope server managed': '服务端管理',
    'Data scope server managed tip': '该字段由数据归属设置管理，建议不要作为普通表单项编辑。',
    'Data scope none confirm title': '确认关闭数据归属',
    'Data scope none confirm content': '当前数据表包含 admin_id 字段，选择“全局数据”后该字段将不会被识别为管理员层级数据。请明确确认此操作。',
    'Data scope owner is pk tip': '归属字段为主键时，不能开启新增自动绑定。',
    'Data scope compatible fields only': '仅显示可作为归属字段的兼容字段（整数类型或 admin_id）',
}
