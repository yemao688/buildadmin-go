export default {
    ...
    'No image in clipboard': '没检测到截图信息，请先操作截图',
    'Failed to read clipboard': '读取粘贴板失败，请检查浏览器权限',
    'Clipboard read is not supported': '当前浏览器不支持读取粘贴板',
    'Drop image here to upload': '拖拽图片到此处上传',
    'Drop file here to upload': '拖拽文件到此处上传',
    'No valid image in drop': '请拖拽图片文件',
    'No valid file in drop': '请拖拽有效文件',
    'No valid file in paste': '没检测到可上传的文件，请先复制文件',
    'Copy paste upload tip': '支持 Ctrl+C 复制文件，Ctrl+V 粘贴上传',
    Icon: '图标',
