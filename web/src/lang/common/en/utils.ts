export default {
    ...
    'No image in clipboard': 'No screenshot detected, please take a screenshot first',
    'Failed to read clipboard': 'Failed to read clipboard, please check browser permissions',
    'Clipboard read is not supported': 'Clipboard read is not supported in this browser',
    'Drop image here to upload': 'Drop image here to upload',
    'Drop file here to upload': 'Drop file here to upload',
    'No valid image in drop': 'Please drop image files',
    'No valid file in drop': 'Please drop valid files',
    'No valid file in paste': 'No uploadable file detected, please copy a file first',
    'Copy paste upload tip': 'Copy files with Ctrl+C, then press Ctrl+V to upload',
    Icon: 'Icon',
