...
var boundaryRules = []boundaryRule{
	{code: "R1", ownerPrefix: "admin/", bannedPrefixes: []string{modulePath + "/app/api"}},
	{code: "R2", ownerPrefix: "api/", bannedPrefixes: []string{modulePath + "/app/admin"}},
	{code: "R3", ownerPrefix: "common/", bannedPrefixes: []string{modulePath + "/app/admin", modulePath + "/app/api"}},
}
