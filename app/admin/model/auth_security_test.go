...
func newAdminAuthSecurityModel(t *testing.T, tokenData *token.Token) (*AuthModel, *gorm.DB) {
	t.Helper()
	...
	return NewAuthModel(db, &token.TokenHelper{Driver: adminAuthSecurityTokenDriver{data: tokenData}}, config), db
}
