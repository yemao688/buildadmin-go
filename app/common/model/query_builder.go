// Package model provides common model types and delegates query building to
// app/pkg/querybuilder for compatibility with existing callers.
package model

import (
	"go-build-admin/app/pkg/querybuilder"
