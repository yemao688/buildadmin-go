...
func newSecurityFixture(t *testing.T) *securityFixture {
	...
	stmts := []string{
		...
		"CREATE TABLE " + q("security_data_recycle") + " (id INT AUTO_INCREMENT PRIMARY KEY, admin_id INT NOT NULL, name VARCHAR(64) NOT NULL, controller VARCHAR(64) NOT NULL, controller_as VARCHAR(64) NOT NULL, data_table VARCHAR(64) NOT NULL, primary_key VARCHAR(64) NOT NULL, status VARCHAR(8) NOT NULL, connection VARCHAR(64) NOT NULL DEFAULT '', update_time BIGINT NOT NULL DEFAULT 0, create_time BIGINT NOT NULL DEFAULT 0)",
		...
		"CREATE TABLE " + q("security_sensitive_data") + " (id INT AUTO_INCREMENT PRIMARY KEY, admin_id INT NOT NULL, name VARCHAR(64) NOT NULL, controller VARCHAR(64) NOT NULL, controller_as VARCHAR(64) NOT NULL, data_table VARCHAR(64) NOT NULL, primary_key VARCHAR(64) NOT NULL, data_fields TEXT NOT NULL, status VARCHAR(8) NOT NULL, connection VARCHAR(64) NOT NULL DEFAULT '', update_time BIGINT NOT NULL DEFAULT 0, create_time BIGINT NOT NULL DEFAULT 0)",
