...
func TestGetRemoteSelectUrl(t *testing.T) {
	cases := []struct {
		...
		{"unknown controller falls back to path derivation", crudmodel.Field{Form: crudmodel.FormAttr{RemoteController: "app/admin/handler/no_such_handler.go", RemoteSourceConfigType: "crud"}}, "/admin/no.SuchHandler/index"},
