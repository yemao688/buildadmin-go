...
func wireApp(configuration *conf.Configuration, logger *lumberjack.Logger, zapLogger *zap.Logger) (*commands.ServerApp, func(), error) {
	...
	authService := service.NewAuthService(configuration, authRepository, clickCaptcha)
	...
	adminService := service.NewAdminService(adminRepository, authRepository)
	...
	sensitiveDataService := service.NewSensitiveDataService(sensitiveDataRepository)
	sensitiveDataHandler := handler.NewSensitiveDataHandler(zapLogger, configuration, sensitiveDataRepository, tableRepository, sensitiveDataService)
	...
	moneyLogRepository := repository.NewMoneyLogRepository(gormDB, configuration, closureEnforcer, userBalanceService)
