...
const TableNameBaSecurityDataRecycleLog = "ba_security_data_recycle_log"

// BaSecurityDataRecycleLog 数据回收记录表
type BaSecurityDataRecycleLog struct {
...
// TableName BaSecurityDataRecycleLog's table name
func (*BaSecurityDataRecycleLog) TableName() string {
	return TableNameBaSecurityDataRecycleLog
}
