...
const TableNameBaUserGroup = "ba_user_group"

// BaUserGroup 会员组表
type BaUserGroup struct {
...
// TableName BaUserGroup's table name
func (*BaUserGroup) TableName() string {
	return TableNameBaUserGroup
}
