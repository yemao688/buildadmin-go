...
const TableNameBaSecuritySensitiveDatum = "ba_security_sensitive_data"

// BaSecuritySensitiveDatum 敏感数据规则表
type BaSecuritySensitiveDatum struct {
...
// TableName BaSecuritySensitiveDatum's table name
func (*BaSecuritySensitiveDatum) TableName() string {
	return TableNameBaSecuritySensitiveDatum
}
