...
func wireApp(configuration *conf.Configuration, lumberjackLogger *lumberjack.Logger, zapLogger *zap.Logger) (*App, func(), error) {
	...
	v := router.ProvideRegistrars(countryLanguageRegistrar, countryCurrencyRegistrar, countryLanguageContentRegistrar, crudLogRegistrar, moduleRegistrar, testBuildRegistrar, adminGroupRegistrar, adminRuleRegistrar, userGroupRegistrar, userRuleRegistrar, configRegistrar, attachmentRegistrar)
	engine := router.InitRouter(lumberjackLogger, login, security, userLogin, record, adminHandler, adminInfoHandler, adminLogHandler, indexHandler, dashboardHandler, userHandler, userMoneyLogHandler, userScoreLogHandler, crudHandler, dataRecycleHandler, dataRecycleLogHandler, sensitiveDataHandler, sensitiveDataLogHandler, ajaxHandler, accountHandler, handlerAjaxHandler, commonHandler, emsHandler, handlerIndexHandler, installHandler, handlerUserHandler, demoHandler, v)
