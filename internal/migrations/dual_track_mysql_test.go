...
func TestFrameworkFinalSeedPinnedConnection(t *testing.T) {
	...
	for _, ddl := range []string{
		...
		"CREATE TABLE " + q("security_data_recycle") + " (id INT PRIMARY KEY, name VARCHAR(50) NOT NULL DEFAULT '', controller VARCHAR(100) NOT NULL DEFAULT '', controller_as VARCHAR(100) NOT NULL DEFAULT '', data_table VARCHAR(100) NOT NULL DEFAULT '', primary_key VARCHAR(50) NOT NULL DEFAULT '', status TINYINT UNSIGNED NOT NULL DEFAULT 1, connection VARCHAR(100) NOT NULL DEFAULT '', update_time BIGINT UNSIGNED NULL, create_time BIGINT UNSIGNED NULL)",
		"CREATE TABLE " + q("security_sensitive_data") + " (id INT PRIMARY KEY, name VARCHAR(50) NOT NULL DEFAULT '', controller VARCHAR(100) NOT NULL DEFAULT '', controller_as VARCHAR(100) NOT NULL DEFAULT '', data_table VARCHAR(100) NOT NULL DEFAULT '', primary_key VARCHAR(50) NOT NULL DEFAULT '', data_fields TEXT, status TINYINT UNSIGNED NOT NULL DEFAULT 1, connection VARCHAR(100) NOT NULL DEFAULT '', update_time BIGINT UNSIGNED NULL, create_time BIGINT UNSIGNED NULL)",
