...
import (
	"buildadmin-go/internal/pkg/crudmodel"
...
type Log struct {
	...
	Table      crudmodel.JSON_TABLE  `gorm:"column:table;type:text;comment:数据表数据" json:"table"`                                                                                                    // 数据表数据
	Fields     crudmodel.JSON_FIELDS `gorm:"column:fields;type:text;comment:字段数据" json:"fields"`                                                                                                   // 字段数据
