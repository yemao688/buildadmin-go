...
type Attachment struct {
	...
	Width          int32  `gorm:"column:width;type:int(11) unsigned;not null;comment:宽度" json:"width"`                  // 宽度
	Height         int32  `gorm:"column:height;type:int(11) unsigned;not null;comment:高度" json:"height"`                // 高度
	...
	Quote          int32  `gorm:"column:quote;type:int(11) unsigned;not null;comment:上传(引用)次数" json:"quote"`            // 上传(引用)次数
