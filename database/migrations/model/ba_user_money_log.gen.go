...
type UserMoneyLog struct {
	...
	Money      int32  `gorm:"column:money;type:int(11) unsigned;not null;default:0;comment:变更余额" json:"money"`              // 变更余额
	Before     int32  `gorm:"column:before;type:int(11) unsigned;not null;default:0;comment:变更前余额" json:"before"`           // 变更前余额
	After      int32  `gorm:"column:after;type:int(11) unsigned;not null;default:0;comment:变更后余额" json:"after"`             // 变更后余额
