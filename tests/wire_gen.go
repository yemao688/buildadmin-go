...
// func wireApp(configuration *conf.Configuration, lumberjackLogger *lumberjack.Logger, zapLogger *zap.Logger) (*gin.Engine, func(), error) {
...
// 	userMoneyLogModel := model.NewUserMoneyLogModel(gormDB, configuration)
